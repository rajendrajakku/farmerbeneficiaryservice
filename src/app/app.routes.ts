...
export const routes: Routes = [
  ...
  //  {
  //   path: 'farmer-beneficiary',
  //   loadChildren: () =>
  //     import('./farmer-beneficiary-management/farmer.routes').then(
  //       (m) => m.FARMER_ROUTES
  //     ),
  // },
 // { path: '', redirectTo: 'farmer-beneficiary/dashboard', pathMatch: 'full' },
//  { path: '**', redirectTo: 'farmer-beneficiary/dashboard' },
   //Error
   {
    path: '',
    ...
    children: [
      ...
      // },
      {
        path: 'farmer-beneficiary',
        loadChildren: () =>
          import('./farmer-beneficiary-management/farmer.routes').then(m => m.FARMER_ROUTES),
      },
    ]
  },
