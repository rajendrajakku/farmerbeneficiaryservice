...
@Component({
  selector: 'app-farmer-beneficiary-dashboard',
   imports: [FormsModule,RouterLink,NgApexchartsModule],
  templateUrl: './farmer-beneficiary-dashboard.component.html',
  styleUrl: './farmer-beneficiary-dashboard.component.scss'
})
export class FarmerBeneficiaryDashboardComponent {
  initChecked = false;
    routes = routes;
