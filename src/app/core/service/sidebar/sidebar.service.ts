  ...
  public sidebarData1 = [
    {
      ...
      menu: [
        ...
        // },
        {
          menuValue: 'Beneficiary Dashboard',
          hasSubRoute: true,
          showSubRoute: false,
          icon2: 'layout-grid',
          ...
          subMenus: [
            {
              menuValue: 'Dashboard',
              route: routes.farmerBeneficiaryDashboard,
              base: 'index'
            },
          ],
        },
        {
          menuValue: 'Farmer Beneficiary',
          hasSubRoute: true,
          showSubRoute: false,
          ...
          subMenus: [
            {
              menuValue: 'State wise Farmer Beneficiary',
              route: '/farmer-beneficiary/StateWiseComponent',
              base: 'farmer-beneficiary',
            },
            {
              menuValue: 'District wise Farmer Beneficiary',
              route: '/farmer-beneficiary/DistrictWiseComponent',
              base: 'farmer-beneficiary',
            },
            {
              menuValue: 'Taluka wise Farmer Beneficiary',
              route: '/farmer-beneficiary/TalukaWiseComponent',
              base: 'farmer-beneficiary',
            },
            {
              menuValue: 'Upload wise Farmer Beneficiary',
              route: '/farmer-beneficiary/UploadWiseComponent',
              base: 'farmer-beneficiary',
            },
            {
              menuValue: 'Create Farmer Beneficiary',
